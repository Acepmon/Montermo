    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <?php
                $db = new db\Connector();
                $db->query("select * from news where news_lang = 'english' order by news_id desc");
                $newses = $db->resultset();
                ...
                foreach ($broke_news[$page] as $news) {
                    ...
                    <div class="news_post">
                        ...
                        <P>Posted on <?php echo $news['news_date']; ?></P>
                        ...
                        <a href="newsSpecific.php?news_id=<?php echo $news['news_id']; ?>" class="btn btn-primary">Read More</a>
                    </div>
                    <?php
                }
                ...
                <ul class="pager">
                    <li class="previous">
                        ...
                        ?>
                        <a href="news.php?page=<?php echo $dec_page; ?>">&larr; Newer</a>
                    </li>
                    <li class="next">
                        <?php 
                        $inc_page = $page;
                        ...
                        ?>
                        <a href="news.php?page=<?php echo $inc_page; ?>">Older &rarr;</a>
                    </li>
                </ul>
