            ...
            <div class="col-md-8 col-sm-6 col-xs-2">
                <div class="main-menu">
                    <ul class="visible-lg visible-md">
                        <li <?php if ($page == 5) echo "class='active'"; ?>><a href="about.php">Бидний тухай</a></li>
                        <li <?php if ($page == 2) echo "class='active'"; ?>><a href="products.php">Бүтээгдэхүүн</a></li>
                        <li <?php if ($page == 4) echo "class='active'"; ?>><a href="careers.php">Үйлчилгээ</a></li>
                        <li <?php if ($page == 3) echo "class='active'"; ?>><a href="news.php">Мэдээ</a></li>
                        <li <?php if ($page == 6) echo "class='active'"; ?>><a href="contact.php">Холбоо барих</a></li>
                    </ul>
